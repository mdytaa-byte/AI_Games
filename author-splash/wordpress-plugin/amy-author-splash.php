 ...
 * Description: Engaging homepage splash for family-friendly comedic fantasy. Add [amy_splash] to a page, then set that page as your homepage.
 * Version: 1.0.0
...
function amy_splash_post_has_shortcode() {
	...
	$post = get_post();
	return $post && has_shortcode( $post->post_content, 'amy_splash' );
}
